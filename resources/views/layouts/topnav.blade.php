<div class="navbar navbar-default">
    <div class="navbar-header">
        <a class="navbar-brand navbar-brand-center" style="padding: 0" href="{{ url('/') }}">
            <img class="navbar-brand-logo" style="height: 93px" src="{{ asset('img/logo_blue_white.png') }}" alt="Ponacare">
        </a>
    ...
    <div class="navbar-toggleable">
        <nav id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" href="blank-page.html#" role="button" data-toggle="dropdown" aria-haspopup="true">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                        ...
                        <div class="dropdown-body">
                            <div class="list-group list-group-divided custom-scrollbar">
                                <a class="list-group-item" href="blank-page.html#">
                        ...
                        <div class="dropdown-footer">
                            <a class="dropdown-btn" href="blank-page.html#">See All</a>
                        </div>
                    </div>
                </li>
                <li class="dropdown">
                  ...
                  <span class="icon-with-child hidden-xs">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                        <div class="dropdown-header">
                            <a class="dropdown-link" href="blank-page.html#">Mark all as read</a>
